...
var form_data_2 = __importDefault(require("form-data"));
/**
...
const exampleQuery = `query GetPetQuery ($input: PetsInput) {
  pet(input: $input) {
    name @client
    id
    createdAt @client
...
console.log(createRequestBody(exampleQuery, exampleVars))